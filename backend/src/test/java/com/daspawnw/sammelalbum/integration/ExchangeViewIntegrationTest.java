...
public class ExchangeViewIntegrationTest {
    ...
    @Autowired
    private com.daspawnw.sammelalbum.repository.UserRepository userRepository;
    ...
    void getSentRequests_ShouldReturnRequests_WithCorrectVisibility() {
        ...
        com.daspawnw.sammelalbum.model.User david = userRepository.findById(4L).orElseThrow();
    ...
    void getReceivedOffers_ShouldReturnOffers_WithCorrectVisibility() {
        ...
        com.daspawnw.sammelalbum.model.User alice = userRepository.findById(1L).orElseThrow();
        ...
        ExchangeRequestDto dto1 = receivedOffers.stream().filter(r -> r.getId().equals(req1.getId())).findFirst()
                .orElseThrow();
        assertNull(dto1.getPartnerFirstname());
        assertNull(dto1.getPartnerLastname());
        assertNull(dto1.getPartnerContact());
        ...
        // Verify req2 (EXCHANGE_INTERREST)
        ExchangeRequestDto dto2 = receivedOffers.stream().filter(r -> r.getId().equals(req2.getId())).findFirst()
                .orElseThrow();
        assertNotNull(dto2.getPartnerFirstname());
        assertNotNull(dto2.getPartnerLastname());
        assertNotNull(dto2.getPartnerContact());
